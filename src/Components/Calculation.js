...
const Calculation = () => {
  ...
  return (
    <div className="my-5 mx-10 bg-gray-100 p-3 rounded-lg md:w-[400px] shadow-lg">
      <div className=" font-bold text-center mb-10">START HERE</div>

      <div>
        <ul className="flex my-5 items-center">
          <li className=" mr-5 font-semibold text-blue-500">GENDER: </li>
          <li
            className={` text-sm flex items-center  mr-5 cursor-pointer p-1 rounded-md ${
              gender === "MALE" ? " bg-gray-200  border-2 border-gray-500" : ""
            }`}
        ...
        <div>
          <span className=" mr-5 font-semibold text-blue-500">
            BODY WEIGHT IN KGS:{" "}
          </span>
          <input
        ...
        <div className="flex my-5 mt-10 justify-between">
          <div>
            <div className="flex flex-col items-center">
              <span className="text-center text-blue-500 font-semibold">
                BEER{" "}
              </span>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
              <span className="text-sm">VOLUME (ml)</span> {/* Adding volume label for wine */}
              <input
                className="w-20 p-1 rounded-lg"
                type="number"
                placeholder="0"
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center">
              <span className="text-sm">VOLUME (ml)</span> {/* Adding volume label for liquor */}
              <input
                className="w-20 p-1 rounded-lg"
                type="number"
                placeholder="0"
        ...
        <div className="flex items-center">
          <button
            ...
            className="p-1 bg-blue-200 rounded-lg border font-semibold border-blue-500 mr-5"
          >
            CALCULATE BAC
          </button>
          <button
            className="p-1 bg-blue-200 rounded-lg border font-semibold border-blue-500 "
            onClick={resetForm}
          >
            {" "}
        ...
        <div className="my-5 font-semibold text-blue-500">
